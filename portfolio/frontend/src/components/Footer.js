...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/harish044',
      icon: (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/Harry044',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6">
              Passionate about leveraging analytical skills and cutting-edge technologies to solve real-world problems through data insights and artificial intelligence.
            </p>
